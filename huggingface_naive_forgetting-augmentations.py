...
m2f_datasets = {
    "A": {
        "train": Mask2FormerDataset(datasets["A"][0], m2f_preprocessor_A, transform=train_transforms_ColorAugSSD),
        "val": Mask2FormerDataset(datasets["A"][1], m2f_preprocessor_A),
        "test": Mask2FormerDataset(datasets["A"][2], m2f_preprocessor_A),
    },
    "B": {
        "train": Mask2FormerDataset(datasets["B"][0], m2f_preprocessor_B, transform=train_transforms_ColorAugSSD),
...
BG_VALUE_255=255
base_run_name="M2F-Swin-Tiny-Train_Cadis_ColorAugSSD"
new_run_name="M2F-Swin-Tiny-Naive_Forgetting_ColorAugSSD"
...
# get_ipython().system('CUDA_LAUNCH_BLOCKING=1')
...
for epoch in range(NUM_EPOCHS):
    ...
    try:
        ...
        print(f"Error computing mean IoU - UnidentifiedImageError: {e}")
        # Handle the specific error (optional):
        # For example, you might want to log the specific error and continue or assign a default value
        mean_train_iou = 0  # or assign a default value like 0.0 or -1.0
    except Exception as e:
        print(f"Error computing mean IoU - Exception: {e}")
        # Handle other exceptions if needed
        mean_train_iou = 0  # or handle the error in an appropriate way
    ...
    try:
        ...
        # Handle the specific error (optional):
        # For example, you might want to log the specific error and continue or assign a default value
        mean_val_iou = 0  # or assign a default value like 0.0 or -1.0
    except Exception as e:
        print(f"Error computing mean IoU - Exception: {e}")
        # Handle other exceptions if needed
        mean_val_iou = 0  # or handle the error in an appropriate way
...
try:
    ...
    mean_test_iou = test_metrics_A["mean_iou"]
        ...
        # Handle the specific error (optional):
        # For example, you might want to log the specific error and continue or assign a default value
        mean_test_iou = 0  # or assign a default value like 0.0 or -1.0
except Exception as e:
        print(f"Error computing mean IoU - Exception: {e}")
        # Handle other exceptions if needed
        mean_test_iou = 0  # or handle the error in an appropriate way
